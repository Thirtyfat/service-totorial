...
import com.mglj.totorial.framework.tools.json.ArrayObjectConfuseDeserializationProblemHandler;
...
public class JsonUtils {
	...
	private static JavaType constructParametricType(ObjectMapper mapper, Class<?> parametrized, Class... parameterClasses) {
		ObjectMapper _mapper = mapper;
		if(_mapper == null) {
			_mapper = defaultMapper;
		}
	...
	private static <T> T parse(final ObjectMapper mapper, String value, JavaType javaType) {
		if(javaType == null) {
